...
- **Field Guide** (au centre) : recherche globale et accès à tout : catchable right now, route du jour,
  ...
  439 vêtements) et décoration (797 meubles), prix de vente par qualité (Basic à Osmium), offrandes, quêtes,
  outils et compétences, conseils.
...
Polices : IM Fell English, Newsreader et Courier Prime (SIL Open Font License), embarquées. Esthétique « journal de bord », palette récif tropical (turquoise, corail, sable le jour ; lagon nocturne turquoise vif la nuit).
